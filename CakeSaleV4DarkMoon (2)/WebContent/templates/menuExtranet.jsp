<nav class="navbar navbar-static-top navbar-default navbar-header-full navbar-dark yamm" role="navigation" id="header">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a id="ar-brand" class="navbar-brand hidden-lg hidden-md hidden-sm" href="index.jsp">Tortas <span>Encantada</span></a>
        </div> <!-- navbar-header -->
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown yamm-fw">
                    <a href="${pageContext.request.contextPath}/a_catalogo">Catalogo</a>
